...
from carla_client_train import CarEnv, MEMORY_FRACTION


MODEL_PATH = 'models/Xception___-41.00max_-147.20avg_-242.00min__1699909962.model'
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        while True:
            ...
            cv2.imshow(f'images - play', images)
            cv2.waitKey(10)
